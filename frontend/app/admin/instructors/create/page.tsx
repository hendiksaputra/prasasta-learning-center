...
export default function CreateInstructorPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(error.response?.data?.message || 'Gagal menambahkan instruktur');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Tambah Instruktur Baru</h1>
            <p className="text-gray-600 mt-1">Isi informasi instruktur di bawah ini</p>
          </div>
        </div>
      </div>
            ...
            {qualifications.map((qualification, index) => (
              <div key={index} className="flex gap-2">
                <input
                  ...
                  placeholder={`Kualifikasi ${index + 1}: Contoh: Sertifikasi BNSP Mekanik Alat Berat`}
                />
